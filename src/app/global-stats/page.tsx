...
export default async function GlobalStatsPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#dce3f8] text-slate-800 font-sans flex flex-col justify-between selection:bg-[#f2a893] selection:text-white">
      ...
      <header className="container mx-auto px-6 py-6 flex items-center justify-between z-10">
        ...
        <span className="text-xs text-[#e07f67] font-bold px-3 py-1 rounded-full border border-[#f5c6bb] bg-white/80 backdrop-blur-md shadow-sm">
      ...
      <main className="container mx-auto px-6 py-12 md:py-20 flex flex-col items-center justify-center flex-1 z-10 max-w-4xl">
        <div className="text-center flex flex-col items-center gap-6 mb-12">
          <div className="p-3 bg-gradient-to-tr from-[#e07f67] to-[#f2a893] rounded-2xl shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-12">
          ...
          <div className="relative p-6 rounded-3xl border border-slate-100 bg-white shadow-xl group overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <Clock className="w-24 h-24 text-[#e07f67]" />
            </div>
            <p className="text-xs font-extrabold text-[#e07f67] uppercase tracking-wider mb-2">Total Focus Time</p>
          ...
          <div className="relative p-6 rounded-3xl border border-slate-100 bg-white shadow-xl group overflow-hidden">
            ...
            <p className="text-xs font-extrabold text-[#e07f67] uppercase tracking-wider mb-2">Tasks Completed</p>
            <h2 className="text-4xl font-black text-slate-900 tracking-tight font-mono mb-2">
          ...
          <div className="relative p-6 rounded-3xl border border-slate-100 bg-white shadow-xl group overflow-hidden">
            ...
            <p className="text-xs font-extrabold text-[#e07f67] uppercase tracking-wider mb-2">Total Creators</p>
            <h2 className="text-4xl font-black text-slate-900 tracking-tight font-mono mb-2">
        ...
        <div className="p-6 rounded-3xl border border-dashed border-[#e07f67]/30 bg-[#fffbfa] text-center max-w-md w-full shadow-sm">
          ...
          <p className="font-caveat text-3xl text-[#e07f67]">
