...
export default async function GlobalStatsPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#FAF6E3] text-slate-800 font-sans flex flex-col justify-between selection:bg-[#7B52AB]/20 selection:text-[#3E2361]">
      {/* Background soft glows */}
      <div className="absolute top-[-20%] left-[-10%] h-[600px] w-[600px] rounded-full bg-[#EADBF7]/40 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] h-[600px] w-[600px] rounded-full bg-[#FAF6E3]/40 blur-[120px] pointer-events-none" />
      ...
      <header className="container mx-auto px-6 py-6 flex items-center justify-between z-10">
        ...
        <span className="text-xs text-[#B88D15] font-bold px-3 py-1 rounded-full border border-[#EADBF7] bg-white/80 backdrop-blur-md shadow-sm">
      ...
      <main className="container mx-auto px-6 py-12 md:py-20 flex flex-col items-center justify-center flex-1 z-10 max-w-4xl">
        <div className="text-center flex flex-col items-center gap-6 mb-12">
          <div className="p-3 bg-gradient-to-tr from-[#B88D15] to-[#7B52AB] rounded-2xl shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-12">
          ...
          <div className="relative p-6 rounded-3xl border border-slate-100 bg-white shadow-xl group overflow-hidden">
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <Clock className="w-24 h-24 text-[#B88D15]" />
            </div>
          ...
          <div className="relative p-6 rounded-3xl border border-slate-100 bg-white shadow-xl group overflow-hidden">
            ...
            <p className="text-xs font-extrabold text-[#B88D15] uppercase tracking-wider mb-2">Tasks Completed</p>
            <h2 className="text-4xl font-black text-slate-900 tracking-tight font-mono mb-2">
        ...
        <div className="p-6 rounded-3xl border border-dashed border-[#B88D15]/30 bg-[#FAF6E3] text-center max-w-md w-full shadow-sm">
      ...
      {/* Footer */}
      <footer className="border-t border-[#B88D15]/20 py-6 text-center text-xs text-slate-500 font-semibold z-10 bg-white/10">
