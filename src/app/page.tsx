    ...
    <div className="min-h-screen bg-[#D5DEFF] text-slate-800 font-sans selection:bg-[#f2a893] selection:text-white relative">
      ...
      <header className="border-b border-[#e07f67]/20 bg-[#e07f67]/10 backdrop-blur-lg sticky top-0 z-40 shadow-sm">
        <div className="mx-auto max-w-7xl px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => setIsLoginOpen(true)}
              className="bg-[#4F65A2]/78 hover:bg-[#4F65A2]/90 border border-[#4F65A2]/40 text-white font-extrabold px-5 py-2 rounded-full text-xs uppercase tracking-wider shadow-md hover:shadow-lg transition-all backdrop-blur-md"
            >
              Get Started
            </button>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-12 md:py-20 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6 text-left">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#4F65A2]/15 border border-[#4F65A2]/20 text-[#324270] text-[11px] font-black tracking-wider uppercase w-fit">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-2">
            <button
              onClick={() => setIsLoginOpen(true)}
              className="bg-[#4F65A2]/78 hover:bg-[#4F65A2]/90 border border-[#4F65A2]/40 text-white font-extrabold px-8 py-3.5 rounded-full text-[0.95rem] shadow-md hover:shadow-lg transition-all backdrop-blur-md"
            >
              Start Focusing
            </button>
            <a
              href="#features"
              className="bg-white/35 hover:bg-white/55 border border-white/50 text-[#324270] font-extrabold px-6 py-3.5 rounded-full text-[0.95rem] shadow-sm transition-all flex items-center gap-2 backdrop-blur-sm"
            >
      ...
      <section className="bg-[#e07f67]/5 py-20 border-y border-slate-200/40">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            {/* Review 1 */}
            <div className="bg-[#4F65A2]/10 p-8 rounded-3xl border border-[#4F65A2]/20 shadow-md backdrop-blur-lg hover:bg-[#4F65A2]/15 transition-all text-left flex flex-col justify-between gap-6">
              ...
              <div className="flex items-center gap-3 mt-2">
                <div className="w-9 h-9 rounded-full bg-[#4F65A2]/15 text-[#324270] font-black text-xs flex items-center justify-center border border-[#4F65A2]/30">
                  EJ
                </div>
                <div>
            ...
            <div className="bg-[#4F65A2]/10 p-8 rounded-3xl border border-[#4F65A2]/20 shadow-md backdrop-blur-lg hover:bg-[#4F65A2]/15 transition-all text-left flex flex-col justify-between gap-6">
              ...
              <div className="flex items-center gap-3 mt-2">
                <div className="w-9 h-9 rounded-full bg-blue-500/10 text-[#324270] font-black text-xs flex items-center justify-center border border-blue-500/20">
                  OS
                </div>
                <div>
            ...
            <div className="bg-[#4F65A2]/10 p-8 rounded-3xl border border-[#4F65A2]/20 shadow-md backdrop-blur-lg hover:bg-[#4F65A2]/15 transition-all text-left flex flex-col justify-between gap-6">
              ...
              <div className="flex items-center gap-3 mt-2">
                <div className="w-9 h-9 rounded-full bg-purple-500/10 text-purple-650 font-black text-xs flex items-center justify-center border border-purple-500/20">
                  SL
                </div>
                <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto mt-16">
          ...
          <div className="bg-[#e07f67]/10 p-8 rounded-[2rem] border border-[#e07f67]/20 shadow-lg backdrop-blur-lg flex flex-col justify-between text-left relative overflow-hidden group">
            ...
            <form action={handleGuestLogin} className="mt-8">
              <button
                type="submit"
                className="w-full text-center bg-white/30 hover:bg-white/55 border border-white/50 text-[#324270] font-extrabold py-3.5 px-4 rounded-2xl transition-all text-xs uppercase tracking-wider shadow-sm backdrop-blur-sm"
              >
                Get Started
              </button>
            </form>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="bg-[#e07f67]/10 border border-[#e07f67]/20 backdrop-blur-lg rounded-[2.5rem] p-10 md:p-16 text-center text-slate-850 shadow-xl relative overflow-hidden">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mt-8 relative z-10">
            <button
              onClick={() => setIsLoginOpen(true)}
              className="bg-[#4F65A2]/78 hover:bg-[#4F65A2]/90 border border-[#4F65A2]/40 text-white font-extrabold px-8 py-3.5 rounded-full text-sm shadow-md hover:shadow-lg transition-all backdrop-blur-md"
            >
              Start focusing now
            </button>
            <button
              onClick={() => setIsLoginOpen(true)}
              className="bg-white/30 hover:bg-white/50 border border-white/55 text-[#324270] font-extrabold px-6 py-3.5 rounded-full text-sm transition-all shadow-sm backdrop-blur-sm"
            >
              Talk to an Expert
            </button>
          </div>
      ...
      <footer className="bg-slate-50 border-t border-slate-200/40 py-16 text-slate-600 text-left relative z-10">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col gap-4">
            <h3 className="text-2xl font-sans font-semibold text-[#4F65A2]/80 tracking-tight">FocusFlow</h3>
            ...
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <form onSubmit={handleMagicLinkSubmit} className="w-full space-y-3 mt-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#4F65A2]/78 hover:bg-[#4F65A2]/90 border border-[#4F65A2]/40 text-white font-extrabold py-3.5 px-4 rounded-2xl transition-all text-xs uppercase tracking-wider shadow-md hover:shadow-lg backdrop-blur-md disabled:opacity-75"
                >
