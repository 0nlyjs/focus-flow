        ...
        <div className="mx-auto max-w-7xl px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className={`w-12 h-7 rounded-full border transition-all duration-300 hidden sm:flex items-center p-0.5 shadow-inner backdrop-blur-md cursor-pointer shrink-0 ${
                isDark
