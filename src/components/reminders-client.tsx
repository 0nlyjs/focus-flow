...
export default function RemindersClient({
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-6 pr-1 transition-all duration-300 overflow-y-auto">
        ...
        <div className="w-full p-6 sm:p-8 rounded-3xl border border-[#B88D15]/20 bg-[#B88D15]/10 shadow-xl backdrop-blur-lg flex flex-col gap-6 shrink-0">
        ...
        <div className="flex-1 flex flex-col gap-4 min-h-0">
          <h3 className="text-xs font-bold text-slate-655 uppercase tracking-wide px-1 flex items-center gap-2 shrink-0">
