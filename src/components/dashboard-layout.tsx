  ...
  return (
    <div className="relative h-screen max-h-screen w-screen overflow-hidden bg-[#FAF6E3] text-slate-800 font-sans flex flex-col justify-between selection:bg-[#7B52AB]/20 selection:text-[#3E2361]">
      ...
      <div
        className={`${
          isSidebarOpen
            ? "translate-x-0 w-80 border-r border-[#7B52AB]/20 bg-[#7B52AB]/10 shadow-2xl pt-24 pb-6 px-6 backdrop-blur-lg"
            : "-translate-x-full border-none p-0"
        } fixed inset-y-0 left-0 z-30 h-full transition-all duration-300 shrink-0 flex flex-col`}
      >
